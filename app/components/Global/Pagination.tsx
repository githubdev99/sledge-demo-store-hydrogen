 ...
 */
export function usePagination(connection: any) {
 ...
 */
function useLoadMoreWhenInView({disabled, inView, isLoading, connection}: any) {
 ...
 */
export function getPaginationVariables(request: any, pageBy: any) {
